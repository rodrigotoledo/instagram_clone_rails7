...
admin_test_user = User.create!(company: company, name: 'Admin test', email: 'admin@test.com', address: Faker::Address.full_address, avatar: Faker::Avatar.image, phone: Faker::PhoneNumber.cell_phone_with_country_code, username: 'admin_test', website: Faker::Internet.url, password: 'aassdd123', password_confirmation: 'aassdd123')
